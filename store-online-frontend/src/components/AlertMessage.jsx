    ...
    return (
        <div>
            ...
            <div
                ...
                onClick={onClose}
            ></div>
            <div className="fixed left-1/2 transform -translate-x-1/2 mt-4 mx-4 px-4 rounded-md border-l-4 border-green-500 bg-green-50 md:max-w-2xl md:mx-auto md:px-8 z-50">
                {/* show message */}
