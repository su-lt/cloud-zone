...
const UpdateOrder = ({ isOpen, onClose }) => {
    ...
    const { updateObject, updateCompleted, errors, error } = useSelector(
        (slice) => slice.category
    );
    // onchange input
    const handleChange = (field, value) => {
        dispatch(handleUpdateOnChange({ field, value }));
    };

    // create click button
    const handleClick = () => {
        dispatch(
            updateCategory({ id: updateObject._id, name: updateObject.name })
        );
    };
