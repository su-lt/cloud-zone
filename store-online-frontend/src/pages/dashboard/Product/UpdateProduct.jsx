...
const CreateOrder = ({ isOpen, onClose }) => {
    ...
    const { updateObject, errors, pending, updateCompleted, error } =
    ...
    const handleInputChange = (field, value) => {
        dispatch(setUpdateObject({ field, value }));
    };
    ...
    const handleImageChange = async (event) => {
        ...
        for (let file of files) {
            if (updateObject.images.length + images.length + files.length > 4)
